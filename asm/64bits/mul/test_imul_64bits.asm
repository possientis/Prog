...
section .text
global test_imul_64bits

; testing assembly multiplication instruction 'imul <reg>'
; the semantics of which is rax*<reg> -> rdx:rax (signed multiplication)
; 
; input:
