section .text
global test_imul_32bits

; testing assembly multiplication instruction 'mul r'
; the semantics of which is eax*r -> edx:eax (signed multiplication)
; 
; input:
...
_eax:
  ...
  and rax, 0xffffffff ; keeping eax
