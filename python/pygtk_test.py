...
class SimpleButtonApp(object):
    ...
    When the button is clicked, it updates the button's label with the
    current time.
    """
    def __init__(self):
        ...
        #Another registration of an event handler. This time, when
        #the button emits the 'clicked' signal, the 'update_button_label'
    ...
    def update_button_label(self, widget, data=None):
        ...
        This is the vent handler method for the 'clicked' event of the button
        """
