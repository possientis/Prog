...
{-# LANGUAGE NoMonoLocalBinds       #-} -- Fails to compile if first pragma
...
module Stitch.Data.IHashSet.Base
  (
    IHashSet
...
import qualified Stitch.Data.IHashMap.Base  as H

import Stitch.Data.Exists
import Stitch.Data.IHashable
import Stitch.Data.IHashMap.Base            (IHashMap, foldrWithKey, equalKeys)
...
instance (TestEquality a, IHashable a, forall i. Read (a i)) 
  => Read (IHashSet a) 
  where
...
map 
  :: (IHashable b, TestEquality b) 
  => (forall i. a i -> b i) 
  -> IHashSet a -> IHashSet b
