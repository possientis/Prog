...
test418 = TestCase  $ assertEqual "test418" (check parser7 "#\\[xxxx")(ch '[') 
test419 = TestCase  $ assertEqual "test419" (check parser7 "#\\]xxxx")(ch ']') 
test420 = TestCase  $ assertEqual "test420" (check parser7 "#\\{xxxx")(ch '{') 
test421 = TestCase  $ assertEqual "test421" (check parser7 "#\\}xxxx")(ch '}') 
test422 = TestCase  $ assertEqual "test422" (check parser7 "#\\£xxxx")(Nothing) 
test423 = TestCase  $ assertEqual "test423" (check parser7 "#\\¬xxxx")(Nothing) 
test424 = TestCase  $ assertEqual "test424" (check parser7 "\\axxxxx")(Nothing) 
...
test473 = TestCase  $ assertEqual "test473" (check parser7 "#\\151xx")(ch 'i') 
test474 = TestCase  $ assertEqual "test474" (check parser7 "#\\152xx")(ch 'j') 
test475 = TestCase  $ assertEqual "test475" (check parser7 "#\\153xx")(ch 'k') 
test476 = TestCase  $ assertEqual "test476" (check parser7 "#\\154xx")(ch 'l') 
test477 = TestCase  $ assertEqual "test477" (check parser7 "#\\155xx")(ch 'm') 
test478 = TestCase  $ assertEqual "test478" (check parser7 "#\\156xx")(ch 'n') 
test479 = TestCase  $ assertEqual "test479" (check parser7 "#\\157xx")(ch 'o') 
test480 = TestCase  $ assertEqual "test480" (check parser7 "#\\160xx")(ch 'p') 

test481 = TestCase  $ assertEqual "test481" (check parser7 "#\\161xx")(ch 'q') 
test482 = TestCase  $ assertEqual "test482" (check parser7 "#\\162xx")(ch 'r') 
test483 = TestCase  $ assertEqual "test483" (check parser7 "#\\163xx")(ch 's') 
test484 = TestCase  $ assertEqual "test484" (check parser7 "#\\164xx")(ch 't') 
test485 = TestCase  $ assertEqual "test485" (check parser7 "#\\165xx")(ch 'u') 
test486 = TestCase  $ assertEqual "test486" (check parser7 "#\\166xx")(ch 'v') 
test487 = TestCase  $ assertEqual "test487" (check parser7 "#\\167xx")(ch 'w') 
test488 = TestCase  $ assertEqual "test488" (check parser7 "#\\170xx")(ch 'x') 

test489 = TestCase  $ assertEqual "test489" (check parser7 "#\\171xx")(ch 'y') 
test490 = TestCase  $ assertEqual "test490" (check parser7 "#\\172xx")(ch 'z') 
test491 = TestCase  $ assertEqual "test491" (check parser7 "#\\101xx")(ch 'A') 
test492 = TestCase  $ assertEqual "test492" (check parser7 "#\\102xx")(ch 'B') 
test493 = TestCase  $ assertEqual "test493" (check parser7 "#\\103xx")(ch 'C') 
test494 = TestCase  $ assertEqual "test494" (check parser7 "#\\104xx")(ch 'D') 
test495 = TestCase  $ assertEqual "test495" (check parser7 "#\\105xx")(ch 'E') 
test496 = TestCase  $ assertEqual "test496" (check parser7 "#\\106xx")(ch 'F') 

test497 = TestCase  $ assertEqual "test497" (check parser7 "#\\107xx")(ch 'G') 
test498 = TestCase  $ assertEqual "test498" (check parser7 "#\\110xx")(ch 'H') 
test499 = TestCase  $ assertEqual "test499" (check parser7 "#\\111xx")(ch 'I') 
test500 = TestCase  $ assertEqual "test500" (check parser7 "#\\112xx")(ch 'J') 
test501 = TestCase  $ assertEqual "test501" (check parser7 "#\\113xx")(ch 'K') 
test502 = TestCase  $ assertEqual "test502" (check parser7 "#\\114xx")(ch 'L') 
test503 = TestCase  $ assertEqual "test503" (check parser7 "#\\115xx")(ch 'M') 
test504 = TestCase  $ assertEqual "test504" (check parser7 "#\\116xx")(ch 'N') 

test505 = TestCase  $ assertEqual "test505" (check parser7 "#\\117xx")(ch 'O') 
test506 = TestCase  $ assertEqual "test506" (check parser7 "#\\120xx")(ch 'P') 
test507 = TestCase  $ assertEqual "test507" (check parser7 "#\\121xx")(ch 'Q') 
test508 = TestCase  $ assertEqual "test508" (check parser7 "#\\122xx")(ch 'R') 
test509 = TestCase  $ assertEqual "test509" (check parser7 "#\\123xx")(ch 'S') 
test510 = TestCase  $ assertEqual "test510" (check parser7 "#\\124xx")(ch 'T') 
test511 = TestCase  $ assertEqual "test511" (check parser7 "#\\125xx")(ch 'U') 
test512 = TestCase  $ assertEqual "test512" (check parser7 "#\\126xx")(ch 'V') 

test513 = TestCase  $ assertEqual "test513" (check parser7 "#\\127xx")(ch 'W') 
test514 = TestCase  $ assertEqual "test514" (check parser7 "#\\130xx")(ch 'X') 
test515 = TestCase  $ assertEqual "test515" (check parser7 "#\\131xx")(ch 'Y') 
test516 = TestCase  $ assertEqual "test516" (check parser7 "#\\132xx")(ch 'Z') 
test517 = TestCase  $ assertEqual "test517" (check parser7 "#\\60xxx")(ch '0') 
test518 = TestCase  $ assertEqual "test518" (check parser7 "#\\61xxx")(ch '1') 
test519 = TestCase  $ assertEqual "test519" (check parser7 "#\\62xxx")(ch '2') 
test520 = TestCase  $ assertEqual "test520" (check parser7 "#\\63xxx")(ch '3') 

test521 = TestCase  $ assertEqual "test521" (check parser7 "#\\64xxx")(ch '4') 
test522 = TestCase  $ assertEqual "test522" (check parser7 "#\\65xxx")(ch '5') 
test523 = TestCase  $ assertEqual "test523" (check parser7 "#\\66xxx")(ch '6') 
test524 = TestCase  $ assertEqual "test524" (check parser7 "#\\67xxx")(ch '7') 
test525 = TestCase  $ assertEqual "test525" (check parser7 "#\\70xxx")(ch '8') 
test526 = TestCase  $ assertEqual "test526" (check parser7 "#\\71xxx")(ch '9') 
test527 = TestCase  $ assertEqual "test527" (check parser7 "#\\!41xx")(ch '!') 
test528 = TestCase  $ assertEqual "test528" (check parser7 "#\\$44xx")(ch '$') 

test529 = TestCase  $ assertEqual "test529" (check parser7 "#\\45xxx")(ch '%') 
test530 = TestCase  $ assertEqual "test530" (check parser7 "#\\46xxx")(ch '&') 
test531 = TestCase  $ assertEqual "test531" (check parser7 "#\\174xx")(ch '|') 
test532 = TestCase  $ assertEqual "test532" (check parser7 "#\\52xxx")(ch '*') 
test533 = TestCase  $ assertEqual "test533" (check parser7 "#\\53xxx")(ch '+') 
test534 = TestCase  $ assertEqual "test534" (check parser7 "#\\55xxx")(ch '-') 
test535 = TestCase  $ assertEqual "test535" (check parser7 "#\\57xxx")(ch '/') 
test536 = TestCase  $ assertEqual "test536" (check parser7 "#\\72xxx")(ch ':') 

test537 = TestCase  $ assertEqual "test537" (check parser7 "#\\74xxx")(ch '<') 
test538 = TestCase  $ assertEqual "test538" (check parser7 "#\\75xxx")(ch '=') 
test539 = TestCase  $ assertEqual "test539" (check parser7 "#\\77xxx")(ch '?') 
test540 = TestCase  $ assertEqual "test540" (check parser7 "#\\76xxx")(ch '>') 
test541 = TestCase  $ assertEqual "test541" (check parser7 "#\\100xx")(ch '@') 
test542 = TestCase  $ assertEqual "test542" (check parser7 "#\\136xx")(ch '^') 
test543 = TestCase  $ assertEqual "test543" (check parser7 "#\\137xx")(ch '_') 
test544 = TestCase  $ assertEqual "test544" (check parser7 "#\\176xx")(ch '~') 

test545 = TestCase  $ assertEqual "test545" (check parser7 "#\\140xx")(ch '`') 
test546 = TestCase  $ assertEqual "test546" (check parser7 "#\\47xxx")(ch '\'') 
test547 = TestCase  $ assertEqual "test547" (check parser7 "#\\42xxx")(ch '"') 
test548 = TestCase  $ assertEqual "test548" (check parser7 "#\\50xxx")(ch '(') 
test549 = TestCase  $ assertEqual "test549" (check parser7 "#\\51xxx")(ch ')') 
test550 = TestCase  $ assertEqual "test550" (check parser7 "#\\73xxx")(ch ';') 
test551 = TestCase  $ assertEqual "test551" (check parser7 "#\\134xx")(ch '\\') 
test552 = TestCase  $ assertEqual "test552" (check parser7 "#\\54xxx")(ch ',') 

test553 = TestCase  $ assertEqual "test553" (check parser7 "#\\56xxx")(ch '.') 
test554 = TestCase  $ assertEqual "test554" (check parser7 "#\\133xx")(ch '[') 
test555 = TestCase  $ assertEqual "test555" (check parser7 "#\\135xx")(ch ']') 
test556 = TestCase  $ assertEqual "test556" (check parser7 "#\\173xx")(ch '{') 
test557 = TestCase  $ assertEqual "test557" (check parser7 "#\\175xx")(ch '}') 
test558 = TestCase  $ assertEqual "test558" (check parser7 "#\\243xx")(ch '£') 
test559 = TestCase  $ assertEqual "test559" (check parser7 "#\\254xx")(ch '¬') 
test560 = TestCase  $ assertEqual "test560" (check parser7 "\\axxxxx")(Nothing) 
...
test_Parse = TestLabel "test_Parse" $ TestList
  ...
  , test553,test554,test555,test556,test557,test558,test559,test560
  ]
