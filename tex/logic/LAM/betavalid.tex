...
\begin{proof}
    ...
    property is also true $\phi$. So let $U,U'\subseteq V$. We need to show
    ...
    for $\phi_{1}$. However, we assumed that the property was true for $\phi_{1}$
