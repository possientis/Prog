{\bf Remark}: The notion is $\beta$-validity defined in this section
...
\begin{prop}\label{logic:prop:LAM:beta:valid:recursion:x:2}
    Let $V$ be a set and $\sigma:V\to\tv$ be a map. Let $\phi\in\tv$
...
\begin{prop}\label{logic:prop:LAM:beta:valid:recursion:app:2}
    Let $V$ be a set and $\sigma:V\to\tv$ be a map. Let $\phi\in\tv$ 
...
\begin{prop}\label{logic:prop:LAM:beta:valid:recursion:lam:2}
    Let $V$ be a set and $\sigma:V\to\tv$ be a map. Let $\phi\in\tv$ 
...
\begin{prop}\label{logic:prop:LAM:beta:validsub:singlevar:2}
...
\begin{prop}\label{logic:prop:LAM:beta:valid:composition:gen:2}
...
\begin{proof}
    ...
    proposition~(\ref{logic:prop:LAM:beta:valid:composition:gen:2}): if we recall
    ...
    then if $\tau$ is $\beta$-valid for $\phi$ we have:
        \begin{eqnarray*}(\sigma'\circ\tau)'(\phi)
            ...
            \mbox{prop.~(\ref{logic:prop:LAM:beta:valid:composition:gen:2})
