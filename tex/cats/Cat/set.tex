...
could also encode as precicates of first order logic. 
\begin{lemma}\label{Cat:lemma:set:is:category}
    The category \Set\ of definition~(\ref{Cat:def:set}) is indeed a
    category.
\end{lemma}
\begin{proof}
    ...
    are satisfied. $(7)$: suppose $f^{*}$ and $g^{*}$ are two members of 
