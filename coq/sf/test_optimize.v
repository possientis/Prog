...
Theorem optimize_0plus_sound2 : forall (a:aexp) (env:State), 
    aeval env (optimize_0plus a) = aeval env a.
Proof.
    intros a. induction a as [n|k|a1 IH1 a2 IH2|a1 IH1 a2 IH2|a1 IH1 a2 IH2]. 
    - reflexivity.
...
Theorem optimize_0plus_b_sound : forall (b:bexp) (env:State),
   beval env (optimize_0plus_b b) = beval env b.
Proof.
    intros b. induction b as [| |a1 a2|a1 a2|b1 IH1|b1 IH1 b2 IH2].
    - reflexivity.
    - reflexivity.
    - simpl. intros env. 
        rewrite (optimize_0plus_sound a1), (optimize_0plus_sound a2).
        reflexivity.
    - simpl. intros env.
        rewrite (optimize_0plus_sound a1), (optimize_0plus_sound a2).
        reflexivity.
