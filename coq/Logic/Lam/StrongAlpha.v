...
(* t1 = Lam x (Lam y (App (Var x) (Var y)))                                     *)
(* t2 = Lam y (Lam x (App (Var y) (Var x)))                                     *)
...
Proof.
    ...
    - destruct H3 as [t1' [H3 H4]]. inversion H4. subst. apply Hxy. reflexivity.
    - destruct H3 as [q1' [r [z [H3 [H4 [H5 [H6 H7]]]]]]].
      ...
      destruct H4 as [H4|H4].
        ...
        + destruct H4 as [s1 [r' [y [H4 [H7 [H8 [H9 H10]]]]]]].
