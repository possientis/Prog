...
Proposition ReplaceSmall : forall (F:BinaryClass) (a:U),
...
Definition replaceSet (F:BinaryClass) (a:U) (p:Functional F) : U
  := toSet F[a] (ReplaceSmall F a p).

(* Characterisation of the elements of the replace set of F a.                  *)
Proposition ReplaceCharac : forall (F:BinaryClass) (a:U) (p:Functional F),
