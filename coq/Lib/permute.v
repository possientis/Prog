...
Lemma permutation_refl : forall (A:Type) (l:list A), permutation l l.
Proof.
  intros A l. apply perm_zero.
Qed.

 
Lemma transposition_sym: forall (A:Type) (l m: list A),
...
Lemma permutation_sym: forall (A:Type) (l m: list A),
...
Proof.
  ...
  apply transposition_sym. exact H2. apply H1. exact H0.
Qed.

Lemma permutation_trans: forall (A:Type) (l m k: list A),
