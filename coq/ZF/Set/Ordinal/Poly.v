...
Proof.
  ...
  assert (forall n, n :< :N -> A n) as H9. {
    ...
    - intros n H3 IH b c d H2 H4 H5 H6 H9 H10.
      ...
      assert (CRL.Functional :[F]:) as H11. { apply From.IsFunctional. }
      assert (forall i, i :< succ n -> CRD.domain :[F]: i) as H12. {
          intros i _. apply From.DomainOf. }
      ...
      rewrite SumOfClass.ShiftL, From.Eval; try assumption.
      remember (shiftL b) as b' eqn:H16.
      remember (shiftL c) as c' eqn:H17.
      assert (OrdFunOn b' n) as H18. {
        rewrite H16. apply ShiftL.OnSucc. assumption. }
      assert (OrdFunOn c' n) as H19. {
        rewrite H17. apply ShiftL.OnSucc. assumption. }
      assert (Decreasing b') as H20. {
        rewrite H16. apply ShiftL.IsDecreasing. 2: assumption. apply H4. }
      ...
      assert (forall i, i :< n -> c'!i :< a) as H22. {
        intros i H22.
        assert (Ordinal i) as G9. {
        apply Ordinal.IsOrdinal with n; assumption. }
        rewrite H17, ShiftL.Eval. 2: assumption.
      ...
      assert (forall i, i :< n -> b'!i :< b!:0:) as H23. {
        ...
        assert (Ordinal i) as G9. {
        apply Ordinal.IsOrdinal with n; assumption. }
        rewrite H16, ShiftL.Eval. 2: assumption.
        - apply H6.
      ...
      assert (:sum:_{n} (CRL.shiftL :[F]:) = :sum:_{n} :[G]:) as H24. {
        ...
        intros i H24.
       assert (Ordinal i) as G9. { apply Ordinal.IsOrdinal with n; assumption. }
        rewrite
          CRL.Eval, From.Eval, From.Eval, E, E', H16, H17, ShiftL.Eval, ShiftL.Eval;
      ...
      assert (forall i, i :< n -> Ordinal b'!i) as G12. {
        intros i G12. apply Ordinal.IsOrdinal with b!:0:. 1: assumption.
        apply H23. assumption. }
      assert (forall i, i :< n -> Ordinal c'!i) as G13. {
        intros i G13. apply Ordinal.IsOrdinal with a. 1: assumption.
      ...
      assert (Ordinal (:sum:_{n} :[G]:)) as G16. {
        ...
        intros i G16. rewrite From.Eval. apply G15. assumption. }
      assert (Ordinal (F :0: :+: :sum:_{n} :[G]:)) as G17. {
        apply Plus.IsOrdinal; assumption. }
      assert (Ordinal (F :0: :+: a :^: b!:0:)) as G18. {
        apply Plus.IsOrdinal; assumption. }
      apply Ordinal.ElemInclTran with (F :0: :+: a :^: b!:0:); try assumption.
...
Proof.
  ...
  assert (OrdFunOn b' n) as G16. { rewrite H12. apply ShiftL.OnSucc. assumption. }
  assert (OrdFunOn m' n) as G17. { rewrite H13. apply ShiftL.OnSucc. assumption. }
  assert (Decreasing b') as G18. {
    rewrite H12. apply ShiftL.IsDecreasing. 2: assumption. apply H3. }
  assert (:1: :< a) as G19. { apply Limit.HasOne. assumption. }
  assert (forall i, i :< n -> m'!i :< a) as G20. {
    intros i G20.
    assert (Ordinal i) as K1. { apply Ordinal.IsOrdinal with n; assumption. }
    apply Omega.IsInclLimit. 1: assumption.
    rewrite H13, ShiftL.Eval.
  ...
  assert (s = :[F]:!:0: :+: :sum:_{n} (CRL.shiftL :[F]:)) as H16. {
    ...
    - intros i H16. apply From.DomainOf. }
  rewrite From.Eval in H16.
  assert (s' = :sum:_{n} (CRL.shiftL :[F]:)) as H17. {
    rewrite H15. apply SumOfClass.Equal. 1: assumption.
    intros i H17.
    assert (Ordinal i) as K1. { apply Ordinal.IsOrdinal with n; assumption. }
    rewrite From.Eval, CRL.Eval, From.Eval,
    H14, H10, H12, H13, ShiftL.Eval, ShiftL.Eval. 1: reflexivity.
    - apply H4.
    - rewrite G8. apply Succ.ElemCompat; assumption.
    - apply H3.
    - rewrite G7. apply Succ.ElemCompat; assumption.
...
Proof.
  ...
  assert (forall b, Ordinal b -> A b) as H4. {
    ...
    - remember :{ :(:0:,q): }: as c eqn:H15.
      ...
      try assumption.
      rewrite From.Eval, (Eval.WhenSingle :0: q c), (Eval.WhenSingle :0: e d);
      try assumption.
    ...
    - assert (a :^: e :*: :1: :<=: a :^: e :*: q) as H15. {
      ...
      assert (OrdFunOn c' (succ n)) as H27. {
        rewrite H26. apply ShiftR.IsOrdFunOnNat; assumption. }
      assert (OrdFunOn d' (succ n)) as H28. {
        rewrite H25. apply ShiftR.IsOrdFunOnNat; assumption. }
      assert (forall i, i :< n -> d!i :< e) as H29. {
        ...
        apply Ordinal.InclElemTran with r; try assumption.
        ...
        - rewrite H24.
          assert (a :^: d!i :*: c!i
            ...
            symmetry. apply (From.Eval (fun i => a :^: d!i :*: c!i)). }
          rewrite H30. apply SumOfClass.IsIncl; try assumption.
          + intros j H31. exists (a :^: d!j :*: c!j).
            apply From.Charac2. reflexivity.
          + intros j H31. rewrite From.Eval.
            apply Mult.IsOrdinal.
      ...
      assert (domain c :<=: :N) as G17. {
        rewrite G12. apply Ordinal.ElemIsIncl; assumption. }
      assert (domain d :<=: :N) as G18. {
        rewrite G13. apply Ordinal.ElemIsIncl; assumption. }
      assert (Ordinal (succ n)) as G19. {
        apply Omega.HasOrdinals. assumption. }
      assert (Decreasing d') as H30. {
        rewrite H25. apply ShiftR.IsDecreasing; try assumption;
      ...
      assert (forall i, i :< succ n -> :0: :< c'!i) as H31. {
        ...
        - rewrite H26, H32, ShiftR.EvalZero; assumption.
        - apply Omega.HasPred in H32. 2: assumption.
          ...
          rewrite H26, H33, ShiftR.EvalSucc; try assumption.
          + apply H22. assumption.
      ...
      assert (forall i, i :< succ n -> c'!i :< a) as H32. {
        ...
        - rewrite H26, H33, ShiftR.EvalZero; assumption.
        - apply Omega.HasPred in H33. 2: assumption.
          ...
          rewrite H26, H34, ShiftR.EvalSucc; try assumption.
          + apply H23. assumption.
          + rewrite G12. assumption. }
      split. 1: assumption. split. 1: assumption. split. 1: assumption.
      split. 1: assumption. split. 1: assumption. split. 1: assumption.
      ...
      assert (:sum:_{succ n} :[G]: = :sum:_{succ n} H) as H36. {
        ...
        - rewrite H37, ShiftR.EvalZero, ShiftR.EvalZero, CRR.EvalZero; try assumption.
        ...
        - apply Omega.HasPred in H37. 2: assumption.
          ...
          rewrite H38, ShiftR.EvalSucc, ShiftR.EvalSucc, CRR.EvalSucc, H33, From.Eval;
          try assumption. 1: reflexivity.
          + apply From.IsFunctional.
          + apply From.DomainOf. }
      rewrite H36, H35.
      assert (:sum:_{succ n} (CRR.shiftR (a :^: e :*: q) :[F]:)
        = a :^: e :*: q :+: :sum:_{n} :[F]:) as H37. {
          ...
          - apply From.IsFunctional.
          - intros j H37. apply From.DomainOf.
          - intros j H37. rewrite From.Eval, H33.
            apply Mult.IsOrdinal.
            + apply Exp.IsOrdinal. 1: assumption.
              apply OrdFunOn.IsOrdinal with n; assumption.
            + apply OrdFunOn.IsOrdinal with n; assumption. }
  ...
  intros b H2.
  assert (b = :0: \/ :0: :< b) as H5. { apply Ordinal.ZeroOrElem. assumption. }
...
Proof.
  ...
  assert (:0: :< a) as G2. {
    apply Natural.HasZero. 1: assumption.
  ...
  assert (a :^: b :*: q1 :+: r1 :< a :^: (succ b)) as H18. {
    ...
    apply Ordinal.ElemInclTran with (a :^: b :*: (succ q1)); try assumption.
    apply Mult.InclCompatR; assumption. }
  apply Ordinal.ElemInclTran with (a :^: (succ b)); assumption.
Qed.
...
Proof.
  ...
  assert (Ordinal :0:) as K1. { apply Ordinal.Zero. }
  ...
  assert (forall n, n :< :N -> A n) as H3. {
    ...
    - intros n H3 IH m c d e f H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15.
      ...
      + apply Omega.HasPred in H16. 2: assumption. destruct H16 as [k [H16 H17]].
        ...
        clear H15.
        remember (ShiftL.shiftL c) as c' eqn:H19.
        remember (ShiftL.shiftL d) as d' eqn:H20.
        remember (ShiftL.shiftL e) as e' eqn:H21.
        remember (ShiftL.shiftL f) as f' eqn:H22.
        remember (fun i => a :^: d'!i :*: c'!i) as F1' eqn:E1'.
        remember (fun i => a :^: f'!i :*: e'!i) as F2' eqn:E2'.
        ...
        assert (OrdFunOn c' n) as G18. {
          rewrite H19. apply ShiftL.OnSucc. assumption. }
        assert (OrdFunOn d' n) as G19. {
          rewrite H20. apply ShiftL.OnSucc. assumption. }
        assert (OrdFunOn e' k) as G20. {
          rewrite H21. apply ShiftL.OnSucc. rewrite <- H17. assumption. }
        assert (OrdFunOn f' k) as G21. {
          rewrite H22. apply ShiftL.OnSucc. rewrite <- H17. assumption. }
        assert (Decreasing d') as G22. {
          rewrite H20. apply ShiftL.IsDecreasing. 2: assumption. apply H6. }
        assert (Decreasing f') as G23. {
          rewrite H22. apply ShiftL.IsDecreasing. 2: assumption. apply H8. }
        assert (forall i, i :< n -> c'!i :< a) as G24. {
          rewrite H19. intros i G24.
          assert (Ordinal i) as G25. {
          apply Ordinal.IsOrdinal with n; assumption. }
...
Proof.
  ...
  assert (a :^: b!:0: :<=: s) as H13. {
    ...
    assert (:[F]:!:0: :<=: :sum:_{succ n} :[F]:) as H13. {
      ...
      intros i H13. apply From.DomainOf. }
    rewrite From.Eval, H10 in H13. rewrite H11, H10. assumption. }
...
Proof.
  ...
  assert (a :^: b!:0: :<=: s) as H21. {
    ...
    - assert (:[F]:!:0: :<=: s) as H21. {
        ...
        intros i H21. apply From.DomainOf. }
      rewrite From.Eval in H21. assumption. }
...
Proof.
  ...
  assert (Ordinal :0:) as G10. { apply Ordinal.Zero. }
...
Proof.
  ...
  assert (c = :0: \/ :0: :< c) as H7. { apply Ordinal.ZeroOrElem. assumption. }
  destruct H7 as [H7|H7].
  - subst.
...
Proof.
  ...
  assert (Ordinal s) as G11. {
    ...
    intros i G11. rewrite From.Eval.
    apply Mult.IsOrdinal.
  ...
  assert (s :<=: a :^: b!:0: :*: succ m!:0:) as H10. {
    apply Ordinal.ElemIsIncl. 1: assumption.
...
Proof.
  ...
  assert (a :^: b!:0: :*: m!:0: :<=: s) as H13. {
    assert (:[F]:!:0: :<=: :sum:_{succ n} :[F]:) as H13. {
      ...
      - apply Succ.HasZero. assumption.
      - intros i H13. apply From.DomainOf.
      - intros i H13. rewrite From.Eval, G13.
        apply Mult.IsOrdinal.
        + apply Exp.IsOrdinal. 1: assumption. apply G2. assumption.
        +apply G3. assumption. }
    rewrite From.Eval, G13 in H13.
