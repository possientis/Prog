...
Proposition MinimalEmptySegment : forall (R A:Class) (a:U),
...
Proof.
  intros R A a x H1 H2. apply MinimalEmptySegment in H1.
  remember (proj1 (InitSegmentWhenEmpty R A a) H1) as H3 eqn:E. clear E H1.
  apply H3. assumption.
Qed.
