...
Require Export ZF.Class.Relation.HasValueAt.
...
(* Evaluation is compatible with class equivalence.                             *)
...
Proof.
  ...
  - apply IsValueAt.EquivCompat with F; assumption.
  - apply IsValueAt.EquivCompat with G. 2: assumption. apply Equiv.Sym. assumption.
Qed.
...
Proof.
  intros F a y H1 H2.
  apply WhenHasValueAt, HasValueAt.WhenFunctionalAt; assumption.
Qed.
...
Proof.
  intros F a y H1 H2.
  apply WhenHasValueAt, HasValueAt.WhenFunctional; assumption.
Qed.
