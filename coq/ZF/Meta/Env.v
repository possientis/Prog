...
Fixpoint fromList (ds:list (string * DeclTerm)) : Env :=
  match ds with
  | []             => empty
...
Definition toSigs (e:Env) : Sigs := fun name =>
  match e name with
  | Some d => Some (DeclTerm.signature d)
  | None   => None
  end.
