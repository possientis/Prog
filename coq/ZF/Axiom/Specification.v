...
Proof.
  ...
  assert (F:[toClass a]: :~: Q) as H2. {
    ...
    - destruct H3 as [x [H3 H4]].
      ...
      apply OrdPair.Equal in H4. destruct H4 as [H4 H7]. subst. split; assumption.
  ...
  apply Image.IsSmallR. 2: apply SetIsSmall.
  ...
  assert (Functional F) as Hf. {
    ...
    apply OrdPair.Equal in H3. destruct H3 as [H3 H9].
    apply OrdPair.Equal in H4. destruct H4 as [H4 H10].
    subst. reflexivity.
  }
