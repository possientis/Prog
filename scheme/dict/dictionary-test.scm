;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; include guard ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(if (not (defined? included-dictionary-test)) 
  (begin
    (define included-dictionary-test #f)
    (display "loading dictionary-test")(newline)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; 
...
(define (dictionary-test filename symbol)
  ...
  (if (not (equal? "{}" (a 'to-string)))
    (display "dictionary: unit test 0.3 failing\n"))
  (if (not (equal? "{}" (b 'to-string)))
    (display "dictionary: unit test 0.4 failing\n"))
  ;; first insert
  ((a 'insert!) 1 10)
  ((b 'insert!) "abc" 100)
  ...
  (if (not (equal? "{1: 10}" (a 'to-string)))
    (display "dictionary: unit test 0.5 failing\n"))
  (if (not (equal? "{\"abc\": 100}" (b 'to-string)))
    (display "dictionary: unit test 0.6 failing\n"))
  ;; dictionaries should not be empty
  (if (a 'empty?) (display "dictionary: unit test 0.7 failing\n"))
...
;  (if(not (b 'check))(display"dictionary: unit test 1.2 failing\n"))
  ...
  ;; should succeed
  (let ((x ((a 'find) 1)))
    (debug "[DEBUG]: dictionary-test: x = ")(debug x)(debug-newline) 
...
;  (if (not(b 'check))(display"dictionary: unit test 46 failing\n"))
  ...
  (let ((x ((a 'find) 1)))
    ...
    (debug "[DEBUG] exiting now...")(debug-newline)(exit 1)
