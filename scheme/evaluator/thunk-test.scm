...
(display "(list? value1): ")(display (list? value1))(newline)
(display "(list? value2): ")(display (list? value2))(newline)

(display "(list? (cadr value1)): ")(display (list? (cadr value1)))(newline)
(display "(list? (cadr value2)): ")(display (list? (cadr value2)))(newline)
(display (native-scheme?))(newline)
(display (strict-eval '(native-scheme?)))(newline)
