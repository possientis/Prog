...
MealBuilder.prototype.startNewMeal = function(){
  console.log("MealBuilder::startNewMeal is not implemented");
};

MealBuilder.prototype.addBurger = function(){
  console.log("MealBuilder::addBurger is not implemented");
};

MealBuilder.prototype.addDrink = function(){
  console.log("MealBuilder::addDrink is not implemented");
};
...
Meal.prototype.showItems = function(){
  for(i =0; i < this._count; ++i){
    item = this._items[i];
    console.log("Item : " + item.name() + ", Packing : " + item.packing().pack()
        + ", Price : " + item.price());
  }
};
...
Item.prototype.price = function(){
  console.log("Item::price is not implemented");
};

Item.prototype.name = function(){
  console.log("Item::name is not implemented");
};

Item.prototype.packing = function(){
  console.log("Item::packing is not implemented");
}
...
Packing.prototype.pack = function(){
  console.log("Packing::pack is not implemented");
};
