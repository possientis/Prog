...
// does not actually console.log, simply returns output string
...
console.log("Everyone:\t\t"       + Person.print(people));
console.log("Not John:\t\t"       + Person.print(notJohns));
console.log("Single or Female:\t" + Person.print(singleOrFemales));
console.log("Males:\t\t\t"        + Person.print(males));
console.log("Single Males:\t\t"   + Person.print(singleMales));
console.log("Females:\t\t"        + Person.print(females));
