...
Shape.prototype.draw = function(){
  console.log("Shape::draw is not implemented");
};
...
AbstractShape.prototype.draw = function(){
  console.log("AbstractShape::draw is not implemented");
};
...
Rectangle.prototype.draw = function(){
  console.log("Drawing " + AbstractShape.asString(this._color) + " rectangle");
}
...
Square.prototype.draw = function(){
  console.log("Drawing " + AbstractShape.asString(this._color) + " square");
}
...
Circle.prototype.draw = function(){
  console.log("Drawing " + AbstractShape.asString(this._color) + " circle");
}
...
AbstractShapeFactory.prototype.getColor = function(){
  console.log("AbstractShapeFactory::getColor is not implemented");
};
