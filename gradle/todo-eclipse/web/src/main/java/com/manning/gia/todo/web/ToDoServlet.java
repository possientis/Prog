...
public class ToDoServlet extends HttpServlet {
    ...
    private String processRequest(
        ...
        if (servletPath.equals(FIND_ALL_SERVLET_PATH)) {
            ...
            request.setAttribute(
                "toDoItems", 
                filterBasedOnStatus(toDoItems, true)
            );
            ...
            request.setAttribute(
                "toDoItems", 
                filterBasedOnStatus(toDoItems, false)
            );
            request.setAttribute("stats", determineStats(toDoItems));
        ...
        if (servletPath.equals("/insert")) {
            ...
            if (toDoItem != null) {
                boolean completed 
                  = "on".equals(request.getParameter("toggle")) ? true : false;
    ...
    private List<ToDoItem> filterBasedOnStatus(
