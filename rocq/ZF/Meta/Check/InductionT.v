...
Combined Scheme Induction_ from CheckTInd_, CheckTsInd_.

(* Checked terms and argument lists have a joint induction principle.           *)
...
Proof.
  ...
  assert (forall (E:Env),
    ...
    (forall (G:Ctx) (ts:Terms) (tys:list Ty),
      CheckTs E G ts tys -> Q E G ts tys)) as H26. {
  ...
  split.
  - intros E G t ty H27. apply (H26 E); assumption.
  - intros E G ts tys H27. apply (H26 E); assumption.
Qed.
