...
Proposition Distrib : forall (a b c:U),
  a :/\: (b:\/:c) = a:/\:b :\/:a:/\:c.
Proof.
  intros a b c. apply Extensionality. intros x. split; intros H1.
...
Proposition UnionDistrib : forall (a b c:U),
  a:\/:b:/\:c = (a:\/:b) :/\: (a:\/:c).
Proof.
  intros a b c. apply Extensionality. intros x. split; intros H1.
  - apply Union2.Charac in H1. destruct H1 as [H1|H1];
...
(* If x is not in the intersection, then x is outside a or outside b.           *)
...
(* a is a subset of b if and only if the intersection of a and b equals a.      *)
...
(* b is a subset of a if and only if the intersection of a and b equals b.      *)
