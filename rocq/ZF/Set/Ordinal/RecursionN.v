...
Proposition WhenZero : forall (f a:U),
  (recursion f a)!:0: = a.
Proof.
  intros f. apply RecursionNOfClass.WhenZero.
Qed.
...
Proof.
  intros f. apply RecursionNOfClass.WhenSucc.
Qed.
...
Proposition IsUnique : forall (f g a:U),
  ...
  g = recursion f a.
Proof.
  intros f g a. apply RecursionNOfClass.IsUnique.
Qed.
